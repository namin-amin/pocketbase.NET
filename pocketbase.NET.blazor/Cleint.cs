...
namespace pocketbase.NET.blazor
{
    ...
    public static class PocketBaseProvider
    {
        ...
        /// <returns></returns>
        public static IServiceCollection AddPocketbase(this IServiceCollection services, string baseUrl, HttpClient? httpClient =  null, string lang = "en-US")
        {
            ...
            {
                return new Pocketbase(baseUrl, lang, httpClient, new RealtimeService(baseUrl,httpClient));
            });
        }
